...
PokemonStore pokemonStoreFromJson(String str) => PokemonStore.fromJson(json.decode(str));

String pokemonStoreToJson(PokemonStore data) => json.encode(data.toJson());
...
class PokemonStore {
  ...
  factory PokemonStore.fromJson(Map<String, dynamic> json) => PokemonStore(
